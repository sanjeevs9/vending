      ...
      >
         ...
         <div className="min-h-screen flex flex-col md:flex-row items-stretch relative z-10">
            ...
            <div className="w-full lg:w-1/3 p-[3vh] lg:p-[5vh] flex flex-col justify-center">
               ...
               <div className="mt-[3vh] space-y-[2vh] md:mt-[4vh]">
                  {/* Contact Details */}
                  ...
                  <div className="mt-[3vh] md:mt-[4vh]">
                     ...
                     <div className="flex mt-[2vh] gap-[1vw]">
            ...
            {/* Form column */}
            <div className="w-full lg:w-2/3 p-[3vh] lg:p-[5vh] flex flex-col justify-center">
               <form onSubmit={handleSubmit}>
                  <div className="space-y-[3vh]">
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-[2vh] md:gap-[2vw]">
                        <div>
                           <input
                              required
                              type="text"
